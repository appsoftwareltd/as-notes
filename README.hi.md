...
# AS Notes (PKMS, स्थैतिक साइट प्रकाशन और ब्लॉगिंग VS Code एक्सटेंशन)
...
**AS Notes मार्कडाउन और `[[wikilink]]` संपादन क्षमताओं को नोट्स, दस्तावेज़, ब्लॉग और विकी के लिए सीधे [VS Code](https://code.visualstudio.com/) और संगत संपादकों (जैसे [Antigravity](https://antigravity.google/), [Cursor](https://cursor.com/), [Windsurf](https://windsurf.com/)) में लाता है। AS Notes, Obsidian या Logseq जैसे PKMS ऐप्स का एक इन-एडिटर विकल्प है।**

**विचारों को रिकॉर्ड करें, अवधारणाओं को जोड़ें, लिखें और केंद्रित रहें - अपने संपादक को छोड़े बिना।**

AS Notes उत्पादकता उपकरण प्रदान करता है जो आपके पसंदीदा IDE को व्यक्तिगत ज्ञान प्रबंधन प्रणाली (PKMS) में बदल देता है, जिसमें बैकलिंक्स दृश्य, कार्य प्रबंधन, जर्नल, कानबन बोर्ड, मार्कडाउन संपादन उपकरण, Mermaid, LaTeX गणित समर्थन और Jekyll / Hugo जैसी प्रकाशन सुविधाएँ शामिल हैं।
...
साइडबार में **कैलेंडर** पैनल जर्नल संकेतकों के साथ वर्तमान माह दिखाता है। किसी भी दिन पर क्लिक करके उसकी जर्नल प्रविष्टि खोलें। विवरण के लिए [कैलेंडर](#दैनिक-जर्नल) देखें।
...
ये कमांड फ़ाइल के YAML फ़्रंट मैटर में प्रकाशन-संबंधित फ़ील्ड को टॉगल या चक्रित करते हैं। विवरण के लिए [स्थैतिक साइट प्रकाशित करना](#as-notes-से-html-में-प्रकाशन-html-रूपांतरण) देखें।
...
#### फ़्रंट मैटर प्रीसेट *(बिना मौजूदा फ़्रंट मैटर वाली फ़ाइलें)*

ये कमांड केवल तब दिखाई देते हैं जब वर्तमान फ़ाइल में कोई YAML फ़्रंट मैटर ब्लॉक न हो। ये आसान संपादन के लिए टैबस्टॉप प्लेसहोल्डर के साथ एक पूर्ण फ़्रंट मैटर टेम्पलेट सम्मिलित करते हैं।

| कमांड | क्रिया |
|---|---|
| **Front Matter: Blog Post** | ब्लॉग पोस्ट के लिए फ़्रंट मैटर सम्मिलित करता है: `title`, `description`, `date` (आज), `author`, `public: true`, `layout: blog` |
| **Front Matter: Docs Page** | दस्तावेज़ पृष्ठ के लिए फ़्रंट मैटर सम्मिलित करता है: `title`, `description`, `public: true`, `layout: docs`, `order` |
| **Front Matter: Wiki Page** | विकी पृष्ठ के लिए फ़्रंट मैटर सम्मिलित करता है: `title`, `description`, `public: true` |
...
Pro कमांड Pro लाइसेंस के साथ उपलब्ध हैं। मुफ़्त उपयोगकर्ता उन्हें मेनू में **(Pro)** जोड़कर सूचीबद्ध देखते हैं।
...
इनलाइन एडिटर सेटिंग्स की पूरी सूची के लिए [सेटिंग्स](#settings) देखें।
...
| कस्टम तिथि प्रारूप | `YYYY`, `YY`, `MM`, `DD`, `HH`, `mm`, `ss` टोकन का कोई भी संयोजन | `{{DD/MM/YYYY}}` → `18/03/2026`, `{{DD/MM/YY}}` → `18/03/26` |
...
- एल्गोरिथ्म: AES-256-GCM, प्रति-एन्क्रिप्शन रैंडम 12-बाइट nonce के साथ
...
### KeePass पासवर्ड सेफ़ (Pro)

Pro उपयोगकर्ता **KeePass Password Safe** साइडबार से मानक **KeePass KDBX 4** (`.kdbx`) पासवर्ड सेफ़ खोल, संपादित और बना सकते हैं - वही फ़ाइलें KeePassXC और अन्य KeePass ऐप्स में खुलती हैं। मास्टर पासवर्ड (साथ में एक वैकल्पिक की फ़ाइल) से अनलॉक करें, समूह और प्रविष्टियाँ ब्राउज़ करें, स्वत: साफ़ होने वाले क्लिपबोर्ड के साथ क्रेडेंशियल और वन-टाइम कोड कॉपी करें, और सेव-ऑन-डिमांड एडिटर में प्रविष्टियाँ (फ़ील्ड, कस्टम फ़ील्ड, टैग, ऑथेंटिकेटर कुंजियाँ, अटैचमेंट, आइकन, समाप्ति और इतिहास) संपादित करें। नए सेफ़ प्रति-फ़ाइल रैंडम साल्ट के साथ Argon2id का उपयोग करते हैं। विवरण और सुरक्षा विचारों के लिए [KeePass Password Safe](https://docs.asnotes.io/keepass-password-safe.html) देखें।
...
### निर्भरताएँ इंस्टॉल करना और सभी पैकेज बनाना

एक रूट `package.json` सभी पैकेजों में काम करने के लिए सुविधा स्क्रिप्ट प्रदान करता है। रिपॉज़िटरी रूट से:
...
> **नोट:** `vs-code-extension` बिल्ड सीधे `../publish/src/convert.ts` को बंडल करता है, इसलिए एक्सटेंशन बनाए जाने से पहले `publish/` (और `common/` पर इसकी निर्भरता) की निर्भरताएँ इंस्टॉल होनी चाहिए। सब कुछ सही क्रम में इंस्टॉल करने के लिए रिपॉज़िटरी रूट से `npm run install:all` का उपयोग करें।
...
> **पूर्वापेक्षा:** `common/` और `publish/` की निर्भरताएँ पहले इंस्टॉल होनी चाहिए (`npm --prefix common install && npm --prefix publish install`), या रिपॉज़िटरी रूट से `npm run install:all` का उपयोग करें।
...
#### ब्लॉग इंडेक्स जनरेशन

जब साइट-व्यापी लेआउट `blog` हो (या कॉन्फ़िग में `blogIndex: true` सेट हो), तो स्वचालित रूप से उत्पन्न इंडेक्स पृष्ठ एक ब्लॉग-जागरूक लेआउट का उपयोग करता है:

1. **हाल की पोस्ट** — सबसे हाल की पोस्ट (`recentCount` के माध्यम से कॉन्फ़िगर करने योग्य, डिफ़ॉल्ट 3) शीर्षक, तिथि, लेखक, विवरण और वैकल्पिक हीरो चित्र के साथ कार्ड के रूप में दिखाई जाती हैं
2. **वर्तमान वर्ष** — वर्तमान वर्ष की शेष पोस्ट एक संक्षिप्त तिथि + शीर्षक सूची के रूप में
3. **वर्ष अभिलेख** — पिछले वर्षों के लिए स्वचालित रूप से उत्पन्न `archive-YYYY.html` पृष्ठों के लिंक
4. **अदिनांकित** — फ़्रंट मैटर में `date` के बिना पोस्ट नीचे सूचीबद्ध होती हैं

#### प्रकाशन के लिए फ़्रंट मैटर फ़ील्ड

| फ़ील्ड | प्रकार | विवरण |
|---|---|---|
| `public` | boolean | प्रकाशित आउटपुट में पृष्ठ शामिल करें |
| `title` | string | पृष्ठ शीर्षक (डिफ़ॉल्ट रूप से फ़ाइल नाम) |
| `description` | string | SEO के लिए मेटा विवरण |
| `date` | string | प्रकाशन तिथि (`YYYY-MM-DD`) — ब्लॉग क्रमबद्धता, RSS और साइटमैप के लिए उपयोग की जाती है |
| `author` | string | पोस्ट लेखक — ब्लॉग लेआउट और RSS फ़ीड में प्रदर्शित |
| `image` | string | हीरो/थंबनेल चित्र पथ — ब्लॉग लेआउट और ब्लॉग इंडेक्स कार्ड में प्रदर्शित |
| `layout` | string | प्रति-पृष्ठ लेआउट ओवरराइड (`docs`, `blog`, `minimal`) |
| `order` | number | नेविगेशन क्रमबद्धता क्रम |
| `draft` | boolean | `--include-drafts` सेट न होने तक आउटपुट से बाहर रखें |
| `assets` | boolean | संदर्भित चित्रों को आउटपुट में कॉपी करें |
| `retina` | boolean | रेटिना चित्र आकार सक्षम करें |

#### ब्लॉग कॉन्फ़िग विकल्प

| विकल्प | प्रकार | डिफ़ॉल्ट | विवरण |
|---|---|---|---|
| `siteTitle` | string | `"AS Notes Site"` | RSS फ़ीड और ब्लॉग इंडेक्स में उपयोग किया जाने वाला साइट शीर्षक |
| `recentCount` | number | `3` | ब्लॉग इंडेक्स पर कार्ड के रूप में दिखाई गई हाल की पोस्ट की संख्या |
| `blogIndex` | boolean | `false` | ब्लॉग-शैली इंडेक्स जनरेशन का उपयोग करें (`layout: "blog"` होने पर स्वत: सक्षम) |
